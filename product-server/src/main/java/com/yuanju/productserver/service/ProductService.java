...
public interface ProductService {
     ...
     * @return org.springframework.data.domain.Page<com.yuanju.productserver.dataobject.ProductInfo>
     */
    Page<ProductInfo> findByCondition(ProductForm productForm);
    ...
    /**
     * @Description  通过传入多个productId获取多条商品信息
     * @Author LJX
     * @Date 2019/1/17 9:24
     * @param productIdList
     * @return java.util.List<com.yuanju.productcommon.ProductInfoOutput>
     */
    List<ProductInfoOutput> findList(List<Integer> productIdList);

    List<ProductInfo> findProduct(List<Integer> productIdList);
